...
//                   <span
//                     className="absolute left-1/2 -bottom-1 w-0 h-[3px] bg-[#ebffc4] rounded-full transition-all duration-300 group-hover:w-3/4"
//                     style={{
...
//               }}
//               onMouseEnter={e => {
//                 e.currentTarget.style.background = "#ebffc4";
...
const navLinks = [
  ...
  { href: "#services", label: "We Serve", icon: HiOutlineBriefcase },
  { href: "#testimonials", label: "Testimonials", icon: HiOutlineChatBubbleLeftRight },
];
    ...
    <>
      <motion.nav
        ...
        className="fixed top-5 left-1/2 -translate-x-1/2 z-50 bg-white/80 backdrop-blur-xl border border-gray-200/75 shadow-xl
          w-[80vw] sm:max-w-[500px] md:max-w-[650px] lg:max-w-[800px] xl:max-w-[900px] 2xl:max-w-[1000px]
      ...
      >
        <div className="flex items-center justify-between px-2 sm:px-4 py-2 sm:py-3 gap-2">
          ...
          {/* Navigation Links */}
          <div className="flex items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4 mx-1 flex-1 min-w-0 justify-center overflow-x-auto">
            {navLinks.map((link) => {
              const Icon = link.icon;
              return (
                <a
                  ...
                  className={`px-3 sm:px-4 py-2 text-sm baloo-text font-medium rounded-full transition-all duration-300 relative overflow-hidden ${
                    activeLink === link.href
                      ? "text-white"
                      : "text-gray-700 hover:text-[#0D263A]"
            ...
            <a
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 4px 24px 0 rgba(199,243,128,0.25)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "#ebffc4";
                e.currentTarget.style.color = "#000";
                e.currentTarget.style.boxShadow =
                  "0 2px 16px 0 rgba(199,243,128,0.15)";
              }}
              onClick={(e) => {
                e.preventDefault();
                setShowForm(true);
